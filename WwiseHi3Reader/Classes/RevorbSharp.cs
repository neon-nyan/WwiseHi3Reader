...
namespace BnkExtractor.Revorb
{
    public unsafe static class RevorbSharp
    {
        ...
        {
            BinaryReader fi = new BinaryReader(inputStream);
            BinaryWriter fo = new BinaryWriter(outputStream);
            ...
            if (Failed)
                Console.WriteLine("Failed to revorb the audio file");
            else
                Console.WriteLine($"Successfully revorbed the audio file");
        }
        ...
        private static bool CopyHeaders(BinaryReader fi, ogg_sync_state* si, ogg_stream_state* @is, BinaryWriter fo, ogg_sync_state* so, ogg_stream_state* os, vorbis_info* vi)
        {
            ...
            {
                Console.WriteLine("Input is not an Ogg.");
                return false;
            }
            ...
            {
                Console.WriteLine("Error in the first page.");
                ogg_stream_clear(@is);
                ogg_stream_clear(os);
                return false;
            }
            ...
            {
                Console.WriteLine("Error in the first packet.");
                ogg_stream_clear(@is);
                ogg_stream_clear(os);
                return false;
            }
            ...
            {
                Console.WriteLine("Error in header, probably not a Vorbis file.");
